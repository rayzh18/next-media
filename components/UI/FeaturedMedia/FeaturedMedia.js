      ...
      <div className="featured-media__bg">
        <div className="featured-media__container">
          ...
          <div className="featured-media__buttons">
            <div className={`featured-media__play-btn ${props.type !== 'single' ? 'hide-comp': ''}`} onClick={clickedPlay}>
              <i className="fas fa-play"/>
            </div>
            <div className={`featured-media__add-btn ${props.type === 'hero' ? '': 'hide-comp'}`} onClick={() => clickedAdd(props)}>
              <i className="fas fa-plus"/>
            </div>
            <div className={`featured-media__info-btn ${props.type === 'hero' ? 'hide-comp': ''}`}  onClick={clickedPlay}>MORE INFO</div>
          </div>
        </div>
      </div>
    </div>
